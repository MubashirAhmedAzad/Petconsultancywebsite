...
const testimonials = [
  {
    ...
    text: "Absolutely amazing service! The team at Pet Consultancy 24×7 transformed my dog Max's behavior. He's now so well-trained and happy. Their nutritional consulting also helped him lose weight safely. I couldn't be more grateful!",
    rating: 5,
  ...
  },
  {
    ...
    role: "Dog Owner",
    pet: "Corgi - Charlie",
    text: "Best pet consultancy ever! From the first visit, they made Charlie feel comfortable. The grooming service is top-notch, and the trainers are patient and knowledgeable. Absolutely worth every penny!",
    rating: 5,
